    ...
    fileEntries.flatMap(([filePath, content]) => {
        ...
        if (!isTypeScript) {
            newContent = newContent
                ...
                .replace(new RegExp("create-verification.ts", "g"), "create-verification.js")
        }
...
const main = async ({isTypeScript, packageManager, rootDirectory}) => {
    ...
    const CREATE_VERIFICATION_COMMAND_PATH = path.join(
        CYPRESS_SUPPORT_PATH,
        `create-verification.${FILE_EXTENSION}`
    )
    ...
    const [
        ...
        fs.readFile(CREATE_VERIFICATION_COMMAND_PATH, "utf-8"),
    ...
    const fileOperationPromises = [
        ...
        ...cleanupCypressFiles({
            fileEntries: [
                ...
                [CREATE_VERIFICATION_COMMAND_PATH, createVerificationCommand],
            ],
            isTypeScript,
            packageManager: pm,
        }),
